...
final class PopupAnimation extends AbstractAnimation {
	...
	protected Timeline setupDismissAnimation() {
	 ...
	 KeyValue kv1 = new KeyValue(stage.yLocationProperty(), stage.getY() + stage.getWidth(), Interpolator.EASE_BOTH);
	 KeyFrame kf1 = new KeyFrame(Duration.millis(2000), kv1);

	 KeyValue kv2 = new KeyValue(stage.opacityProperty(), 0.0, Interpolator.EASE_BOTH);
